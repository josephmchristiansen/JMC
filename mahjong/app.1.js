...
// 	img = (randomNumber(0, 11));
	img = Math.floor((Math.random() * 11) + 0);
// 	console.log(img);
// 	var w = onlyFour[img];
...
img3 = Math.floor((Math.random() * 11) + 0);
...
img2 = Math.floor((Math.random() * 11) + 0);
...
var img1 = 0;
var imgFile1;
img1 = Math.floor((Math.random() * 11) + 0);
// 	console.log(img1);
// 	w = onlyFour[img1];
